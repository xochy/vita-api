...
use App\Models\Traits\Mutators\PhysicalConditionMutators;
...
{
    use HasFactory, HasSlug, PhysicalConditionMutators;
    ...
    /**
     * Get the translations associated with the physical condition.
     *
     * This function establishes a morphMany relationship between PhysicalCondition and Translation.
     * It means that each Physical Condition has many Translations.
     *
     * @return MorphMany
     */
