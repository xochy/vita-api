...
class CommentPolicy
{
    ...
    {
        return $user->can('restore comments') && $user->id === $comment->user_id;
    }
    ...
    {
        return $user->can('force delete comments') && $user->id === $comment->user_id;
    }
}
