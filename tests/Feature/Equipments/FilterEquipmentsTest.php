...
class FilterEquipmentsTest extends TestCase
{
    use RefreshDatabase;

    const MODEL_SINGLE_NAME = 'equipment';
    ...
    /** @test */
    public function can_filter_equipments_by_name()
    {
    ...
    /** @test */
    public function can_filter_equipments_by_description()
    {
        Equipment::factory()->count(3)
            ->state(
                new Sequence(
    ...
    /** @test */
    public function can_filter_equipments_by_name_and_description()
    {
        Equipment::factory()->count(3)
            ->state(
                new Sequence(
    ...
    /** @test */
    public function cannot_filter_equipments_by_unknown_filters()
    {
        $url = route(
            self::MODEL_MAIN_ACTION_ROUTE,
            [
    ...
    /** @test */
    public function can_search_equipments_by_name()
    {
        Equipment::factory()->count(3)
            ->state(
                new Sequence(
    ...
    /** @test */
    public function can_search_equipments_by_description()
    {
        Equipment::factory()->count(3)
            ->state(
                new Sequence(
    ...
    /** @test */
    public function can_search_equipments_by_name_with_multiple_terms()
    {
        Equipment::factory()->count(3)
            ->state(
                new Sequence(
