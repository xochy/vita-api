...
class TranslateSubcategoriesTest extends TestCase
{
    use RefreshDatabase;
    ...
    /** @test */
    public function translations_can_be_associated_to_subcategories()
    {
        ...
        $this->assertDatabaseHas(
            ...
            [
                ...
                'translationable_type' => Subcategory::class,
            ]
        );
    }
